    ...
    return favorites.map((favorite) =>
     { 
        if(favorite.varietalRegionId === wine.id){
            return <button key={favorite.id} className="bg-yellow-500 rounded-full">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="" stroke="currentColor" className="w-6 h-6">
