...
<div className="flex row w-full h-full justify-evenly">
    
<div className="  ">
<h2 className="text-3xl  text-secondary font-bold">Admin Services</h2>
<div className=" border-2 border-secondary rounded-lg flex flex-col justify-center mt-8 mb-8 p-8 my-auto gap-20 bg-fifth h-full">
    ...
    <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        return <li key={customer.id} className="py-3 px-4 sm:py-4   w-full">
            ...
            <div className="flex-shrink-0">
                        <img className="w-16 h-16 rounded-full" src={customer.profilePicture}/>
                    </div>
        ...
        <div className="grid mb-8 w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow-secondary shadow-xl sm:p-8 dark:bg-gray-800 dark:border-gray-700 md:mb-12 md:grid-cols-2">
